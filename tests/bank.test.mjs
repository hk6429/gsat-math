...
test("收錄 106～115 各正式數學考科，每卷 20 題", () => {
  assert.equal(bank.length, 15);
  assert.deepEqual(Array.from(bank, (exam) => `${exam.year}${exam.subject}`), ["115A", "115B", "114A", "114B", "113A", "113B", "112A", "112B", "111A", "111B", "110M", "109M", "108M", "107M", "106M"]);
